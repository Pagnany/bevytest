...
pub fn player_update_transform(
    ...
    player_transform.translation.x += player_velocity.x * time_step.period.as_secs_f32();
    player_transform.translation.y += player_velocity.y * time_step.period.as_secs_f32();
}
